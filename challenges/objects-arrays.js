...
*/
const animalNames = [];
zooAnimals.forEach(ele => {
  animalNames.push(
    `Name: ${ele.animal_name}, Scientific: ${ele.scientific_name}.`
  );
});
...
*/
const largerPopulation = zooAnimals.filter(ele => ele.population < 5);
